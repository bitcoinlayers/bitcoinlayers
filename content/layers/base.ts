                ...
                pegs: [
                    {
                        ...
                        content: "cbBTC on Base is backed Coinbase. This custodian is responsible for custodying BTC that backs cbBTC on its various networks. Users trust Coinbase to not misappropriate the funds backing cbBTC.\n\nIn addition to custodying funds backing cbBTC, Coinbase can censor users from using cbBTC and maintains unilateral control of cbBTC's smart contracts.\n\ncbBTC is natively minted on Base.",
                    },
                    {
                        name: "Threshold tBTC",
