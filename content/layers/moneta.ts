      ...
      content: [
        {
          ...
          content: "Each state transition must contain a validity proof that proves that execution was done correctly to a series of user transactions. If a proof includes an invalid state transition, then a verifier in the BitVM set up can submit a fraud proof to challenge the state transition."
        },
        {
