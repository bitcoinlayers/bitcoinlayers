  ...
  riskAnalysis: [
    {
      ...
      content: "Fractal’s asset bridge between Bitcoin and Fractal is managed by a third party, Bool Network. Bool Network is responsible for custodying the bitcoin assets that back BTC on Fractal.\n\n⚠️ The code behind Bool Network’s bridge is not open-source. We do not know the signing mechanism, or who the signers are, for the Bool Network.\n\n⚠️If a fraudulent withdrawal was processed by the bridge operator, users would have no way to challenge it. Bridge operators can steal funds."
    },
    {
      ...
      content: "The data availability requirement is satisfied by sidechain full nodes. Fractal’s node software is open-source, and anyone can run a full node to verify the current state of the chain.\n\nLike any sidechain, sidechain blocks can be orphaned, so miners are disincentivized to withhold data and not broadcast their blocks as they would not receive mining rewards."
    },
    {
    ...
    },
    {
      ...
      content: "Fractal state transitions are validated by its miner set. After a block is mined by a Fractal miner, it is broadcast to its full node set who validates the block and includes it in the chain."
    }
  ],
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: "Fractal does not leak MEV to bitcoin directly. Bitcoin miners may take advantage of opportunities to extract MEV if the network is experiencing high activity."
        },
        {
          title: "Alternative token used for fees and to incentivize miners",
          content: "Fees on Fractal are paid in FB tokens. Token issuance is paid out in FB tokens to incentivized miners."
        },
        {
          title: "Merge-mining enables Bitcoin miners to earn more fees",
          content: "Fractal contributes to Bitcoin's security budget indirectly by providing Bitcoin miners an opportunity to earn fee revenue via merge-mining."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          content: "Bitcoin Script is bitcoin’s scripting language that enables users to define the conditions under which a Bitcoin UTXO can be spent. It is a low-level Assembly-based programming language.\n\nFractal is based on Bitcoin Script."
        },
        {
          title: "OP_CAT",
          content: "OP_CAT is a Bitcoin opcode, short for Operation Concatenate. It allows the combination of two data elements on the Bitcoin stack. The opcode was originally introduced by Satoshi Nakamoto, but was removed due to potential denial of service attack vectors.\n\nOP_CAT would enable more expressive smart contracts on bitcoin, including “covenants”, a way to set spending conditions on individual UTXOs. Teams are also reviewing how it can support SNARK verification in Script, which would further improve bridging L1 assets to second layer protocols."
        },
        {
          title: "Merge-mining",
        ...
        },
        {
          ...
          content: "Bool Network currently facilitates the bridging of bitcoin assets between Fractal and the Bitcoin mainchain. Bool Network leverages a unique MPC scheme for its signer set, but code on the mechanism is not open-source."
        },
        {
          title: "Faster block times",
          content: "Fractal achieves block confirmation around every 30s."
        }
      ]
    },
    {
