...
const heliosphere: Project = {
  ...
  description: "Heliosphere is building an optimistic rollup on top of Bitcoin.",
  riskAnalysis: [
    {
  ...
  sections: [
    {
      ...
      content: [
        {
          content: "Heliosphere is building an optimistic rollup on top of Bitcoin."
        }
      ]
    },
    {
