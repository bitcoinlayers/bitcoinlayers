...
const zulu: Project = {
  ...
  description: "Zulu Network is building towards becoming a Bitvimium on Bitcoin that enables developers to deploy dApps on both EVM (ZKSync ZK Stack L2) & UTXO layers (Customized ZKVM L3). Zulu network is working on a trust-minimized decentralized bridge program and will leverage a unique hybrid PoS / PoW mining mechanism.",
  riskAnalysis: [
    {
