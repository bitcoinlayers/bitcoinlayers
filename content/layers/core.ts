...
const core: Project = {
  ...
  riskAnalysis: [
    ...
    },
    {
      ...
      content: "Core Chain's data availability requirement is fulfilled by its own network of full nodes. Anyone with enough computational resources can run a Core Chain full node."
    },
    {
      ...
      content: "Core Chain has a network of validators who participate as block producers. Each day, the 23 validators with the highest hybrid score (from DPOW and DPOS) are elected to participate in block production. Any Core chain full node can register to become a part of this set. Core Chain does not support exits that circumvent its validator set. This means that users must trust Core Chain validators to propose and finalize blocks.\n\nThere is a minimum stake to run a Core Chain validator node."
    },
    {
      ...
      content: "State transitions are finalized by Core Chain's consensus mechanism. All roles in this mechanism are minimally permissionless."
    }
  ],
  sections: [
    {
      ...
      content: [
        {
          ...
          content: "As a part of its hybrid consensus mechanism, Bitcoin miners can delegate hashrate to Core validators to improve their overall voting power."
        },
        {
          title: "Core Chain requires another token to function",
          content: "The CORE token is required to pay for transaction fees and smart contract execution on Core Chain. It is also used for staking and governance. The token is directly required for the security of the network, as the staking of it is one of the two variables used to create a weighted score for validator election and leader selection."
        },
        {
          title: "No MEV introduced on Bitcoin",
          content: "Core Chain does not introduce any MEV on Bitcoin. Users trust Core Chain validators to not extract MEV."
        },
        {
          title: "Core Chain indirectly contributes to the security budget.",
          content: "Core validators will reward miners who delegated their hashrate to them with newly issued CORE tokens."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          content: "Core Chain’s consensus-enshrined bridged BTC, coreBTC, relies on several roles for withdrawals, although they are all permissionless. It also relies on the liveness of Core Chain, as one of those roles is a set of smart contracts on Core Chain."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        {
          title: "DeFi",
          content: "The most popular use case for Core Chain is DeFi. Core Chain has a number of DeFi applications, including lending, borrowing, and decentralized exchanges, with a focus on bridged BTC assets."
        },
        {
          title: "BTC Staking",
          content: "Core chain enables BTC holders to natively stake their BTC, as a part of DPOS in Satoshi Plus, and delegate that stake to a specific validator in the Core Chain network."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          content: "Block production is managed by validators participating in the chain's hybrid consensus mechanism."
        }
      ]
    },
    {
