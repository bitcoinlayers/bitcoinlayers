...
const ink: LayerProject = {
    ...
    links: [
        ...
        {
            text: Site.Docs,
            url: "https://inkonchain.com/about",
        },
        {
            text: Site.Explorer,
    ...
    sections: [
        ...
        },
        {
            ...
            content: [
                ...
                },
                {
                    title: "Add a prop on significant tech components. If there is no prop, consider adding one to the prop.ts file. If the tech component is highly customizeable, add text for the content.",
                    content:
                        "The tech is highly customizeable so I'm adding text to describe it.",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            content: [
                {
                    content:
                        "Leave this as is. We'll add files when you submit the PR.",
                },
            ],
        },
    ],
