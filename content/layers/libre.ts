...
const libre: Project = {
  ...
  description: "Libre is a sidechain that leverages a Delegated Proof of Stake (DPoS) consensus mechanism. It currently features three tokens: PBTC, PUSDT, and LIBRE. BTC live on the Libre network is managed by an alternative consensus mechanism that is not directly affiliated with Libre.",
  riskAnalysis: [
    {
      ...
      content: "BTC users who deposit funds onto Libre do so via the pNetwork chain. This is an alternative consensus mechanism that is governed by the pNetwork token and governance. The signers for the pNetwork bitcoin multi-sig, custodying the funds backing pBTC, participate in a MPC protocol.\n\n⚠️ The pNetwork bridge has historically seen two exploits occur. One of those exploits involved BTC-backed tokens.\n\n🔬We are currently reviewing a score for the Libre bridge"
    },
    {
      ...
      content: "The data availability and storage requirement is satisfied by Libre validators. Anyone can participate as a validator after receiving permission from the current validator set to join the candidate pool."
    },
    {
  ...
  sections: [
      ...
      content: [
        {
          ...
          content: "LIBRE token holders can use their voting power to select validators. Voting power is based on the amount of tokens someone has, and how long they’ve been staked. Currently, four accounts hold over 50% of the voting power."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          content: "Users cannot unilaterally from Libre. Users must trust alternative consensus mechanisms to withdrawal funds."
        },
        {
          title: "Libre does not leak MEV to Bitcoin",
          content: "Libre does not leak MEV to the Bitcoin base layer."
        },
        {
          title: "An alternative token plays a role in network security",
          content: "Libre relies on the LIBRE token for network security and operation."
        },
        {
          title: "No fees paid to Bitcoin miners",
          content: "Libre does not contribute to Bitcoin’s security budget."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          content: "When users withdraw funds from the Libre chain, they trust the operators of the Libre chain to include their withdrawal transaction in a block. They additionally trust the operators of the pNetwork to process their withdrawal and release their funds on the Bitcoin main chain."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        {
          title: "Fast payments",
          content: "The Libre blockchain offers faster payments with lower fees than the Bitcoin mainchain."
        },
        {
      ...
      content: [
        {
          ...
          content: "The node implementation for Libre is not open source.\n\nInformation related to the pNetwork bridge is open source."
        }
      ]
    },
    {
      ...
      content: [
        {
          title: "Learn more",
          content: "[Libre website](https://chain.libre.org/)\n[Libre docs](https://docs.libre.org/libre-docs)"
        }
      ]
    }
  ]
