...
>>>>>>> Stashed changes
    ...
    riskAnalysis: [
        ...
        },
        {
            ...
            content:
                "Berachain leverages a novel consensus mechanism for transaction execution. Like CometBFT, it offers single slot finality. This means that once a transaction is added to the cannonical chain, it cannot be reorged.",
        },
    ],
    sections: [
        {
