...
const starknet: Project = {
  ...
  description: "Starknet is a validity rollup on Ethereum. They are proposing a multi-settlement rollup that will settle on Bitcoin and Ethereum should OP_CAT be activated. They are currently developing a STARK verifier directly in Script with OP_CAT on signet.",
  riskAnalysis: [
    {
      ...
      content: [
        {
          ...
          content: "This page provides a high level assessment on a proposed Layer 2 design which requires a soft fork. This page should not be considered a risk assessment."
        }
      ]
    },
    {
