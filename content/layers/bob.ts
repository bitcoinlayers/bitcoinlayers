...
const bob: LayerProject = {
  ...
  bridge: false,
  underReview: false,
  riskFactors: [RiskFactor.Unverified, RiskFactor.Medium, RiskFactor.Medium, RiskFactor.Medium],
  nativeToken: "ETH",
  bitcoinOnly: false,
  links: [
    {
  ...
  riskAnalysis: [
    ...
    },
    {
      ...
      content: "The data for BOB’s state is stored on the Ethereum blockchain. Anyone can run an Ethereum node and verify the state of BOB."
    },
    {
    ...
    },
    {
      ...
      content: "BOB inherits finality guarantees from Ethereum. The BOB sequencer provides a soft confirmation of transactions which are eventually summarized and sent to Ethereum.\n\nBOB's sequencer can reorg prior to a transaction batch being accepted on Ethereum."
    }
  ],
  sections: [
    {
      ...
      content: [
        {
          ...
          content: "BOB is currently developing Optimine: a mechanism that will see Bitcoin miners merge-mine the BOB sequencer. In this design, the BOB sequencer would create rollup blocks, and the miners would validate that the blocks were created correctly. Miners would then give the blocks “Proof-of-Work” validation so they can be executed. This Proof-of-Work validation would take minutes, so it can also act as a soft finalization mechanism as OP Stack chains typically take 7 days for the challenge period to finalize."
        },
        {
          title: "ETH token used to pay fees",
          content: "BOB users pay sequencer fees in ETH. BOB operators also pay DA fees in ETH. Users can, however, elect to pay fees with a separate token (e.g. tBTC) to a service provider that will pay sequencer fees, in ETH, on the users’ behalf."
        },
        {
          title: "No MEV introduced to Bitcoin",
          content: "BOB does not introduce any MEV on the Bitcoin L1. Users trust the BOB sequencer to not reorder their transactions to extract MEV."
        },
        {
          title: "BOB does not contribute to the security budget",
          content: "BOB does not currently contribute to the Bitcoin security budget."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          content: "OP stack chains will use interactive fraud proofs to enforce state correctness. This feature is currently in development, meaning that BOB currently permits invalid state roots."
        },
        {
          title: "Bitcoin Light Client",
          content: "BOB’s Bitcoin light client verifies past transactions on the Bitcoin main chain, and also allows a smart contract on BOB to verify Bitcoin block headers. This gives BOB a view into Bitcoin state, and will be useful for future bridge programs."
        },
        {
          title: "Ethereum Virtual Machine",
          content: "BOB uses an EVM-compatible virtual machine. The Ethereum Virtual Machine is software responsible for smart contract execution for a number of blockchains, namely the Ethereum Network. It uses Solidity/Vyper as its code and is the dominant environment for smart contract execution in the cryptocurrency ecosystem. BOB is EVM-compatible, which means that a developer from Ethereum would have less difficulty deploying their applications on BOB compared to other execution environments."
        },
        {
          title: "Faster block times",
          content: "BOB is currently producing blocks every two seconds which provides a better user experience than using the Bitcoin, or Ethereum, mainchains."
        },
        {
          title: "BitVM bridge being researched",
          content: "BOB are actively researching BitVM and how it can support an improved bridge program for Bitcoin assets on the chain."
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          content: "BOB’s initial use case is to provide Ethereum users access to Bitcoin applications such as ordinals, BRC-20s, Bitcoin backed stablecoins, and more. It also gives Bitcoin users access to an application layer that provides faster confirmation times, lower fees and a superior user experience (albeit with additional trust assumptions). To enable this, BOB supports the BOB SDK, which is a software development kit that enables developers to build Bitcoin-centric applications on BOB."
        },
        {
          title: "Account abstraction",
          content: "BOB will support a number of Bitcoin-UX features via account abstraction. These features will enable users to access BOB via Bitcoin wallets, pay fees in their preferred token, and mint BTC on BOB directly."
        }
      ]
    },
    {
