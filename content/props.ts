...
export enum TokenSnippet { //TODO: Janusz to add more here
    ...
    HemiBTC = "Hemi leverages a federated multisig to secure BTC backing HemiBTC. The signers participating in this federation have not been officially disclosed.",
