      ...
      content: [
        {
          ...
          content: "Chaumian blinding works by allowing a message to be signed without revealing its content to the signer itself. The process involves a blinding factor that obscures the message. The signed blinded message is unblinded by the creator of the message using the original blinding factor. This process was broken down in an easy-to-understand [video explainer by Rijndael](https://x.com/rot13maxi/status/1549766946366840834)."
        },
        {
          title: "Mint module",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: "Cashu tokens carry voucher-like properties. Those tokens can be used to get (privacy-preserving) and accountless access to online services through toll gates: be it an internet connection, [anonymous API access](https://github.com/cashubtc/xcashu), a VPN service, [pay-per-request for LLM prompts](https://chatnut.sparkpay.pt/)."
        },
        {
        ...
        },
        {
          ...
          content: "Ecash-based HTLCs can be atomically linked to Ecash HTLCs ([Calle](https://x.com/callebtc/status/1742948259050500561)). This might enable a submarine swap-equivalent (BTC-LN), called “[submarine nuts](https://x.com/callebtc/status/1704915759808303542)” (Cashu <--> LN), meaning LN nodes can assist one another in receiving funds even if they lack any channels or inbound liquidity."
        },
        {
          title: "Cashu via nostr",
          content: "Cashu tokens can be [sent](https://x.com/CashuBTC/status/1616063616150634498) via [nostr](https://nostr.com/), an open protocol that enables a truly censorship-resistant and global social network. The [message is an encrypted NIP-04 DM](https://x.com/CashuBTC/status/1607423255681318914). Nostr Wallet Connect (NWC) will further [enable users to zap other users with Cashu tokens](https://x.com/callebtc/status/1787519215051715016). A new zap protocol for nostr based on Cashu ecash was recently [proposed](https://github.com/nostr-protocol/nips/pull/1369)."
        },
        {
