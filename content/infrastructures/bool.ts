...
const bool: InfrastructureProject = {
  ...
  description: "Bool Network is an infrastructure provider currently managing bridges for a number of Bitcoin scaling protocols. The Bitcoin wallets it manages are secured by an MPC Protocol.",
  sections: [
    {
      id: "selfsubmit",
