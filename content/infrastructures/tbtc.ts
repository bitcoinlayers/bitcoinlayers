...
const tbtc: InfrastructureProject = {
  ...
  description: "tBTC is a wrapped version of BTC that lives as an ERC-20 token on EVM-based blockchains. Its accounting ledger is Ethereum. The bitcoin backing tBTC is secured by a distributed signer set and staking mechanism.",
  sections: [
    {
      id: "riskbits",
      title: "Risk Bits",
      content: [
        ...
        },
        {
          ...
          content: "Signers of bitcoin wallets backing tBTC are selected by a randomized process known as the sortitiion pool. While random, the overall value of a prospective signer's stake does impact the amount of key shares they receive in the threshold signing scheme. If a propsective signer hold a significant amount of stake (e.g. > 51%), there is a chance they could effectively gain unilateral control of a single bitcoin wallet.\n\nThis is currently mitigated by the fact that tBTC signing privileges are currently permissioned and signers must be approved by the Threshold DAO in its current set up. If tBTC signing privileges became permissionless, the mechanism could be vulernable to malicious parties acquiring a large amount of stake."
        }
      ]
    },
    {
