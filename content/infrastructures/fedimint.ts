    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: "It is being argued that self-custody, in its current form, is difficult for non-tech-savvy users. Fedimints would enable users to deposit their Bitcoin with a federation of trusted “second” parties” (e.g. family member or community leader). Federated community custody may be preferred by some users over the prevailing third party custodial model."
        },
        {
