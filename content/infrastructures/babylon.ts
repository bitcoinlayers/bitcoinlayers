...
const babylon: InfrastructureProject = {
  ...
  description: "Babylon namely supports BTC staking that improves security for Proof-of-Stake (PoS) sidechains. The staking protocol enables participants to stake BTC to secure their preferred sidechain. Babylon also acts as a timestamping protocol to improve PoS sidechain's resistance to long-range attacks.",
  sections: [
    {
      id: "selfsubmit",
