...
declare const Alertsnippet: {
    ...
    readonly AltRollupAltTokenNoFraudProofs: {
        readonly type: "error";
        readonly title: "This token is not bridged to the network from bitcoin";
        readonly content: "The token is bridged to the network's from a bridge contract hosted on its parent chain. The bridge does not have a functioning proof system. The proposer can submit a malicious state transition and steal funds from the bridge.";
    };
    readonly StatechainKeyDeletion: {
        readonly type: "warning";
        readonly title: "Statechain entity cannot prove key deletion";
        readonly content: "In statechains, there is no way to cryptographically prove that a statechain entity has deleted a keyshare it held with a previous owner. Users must trust the statechain entity to act honestly. If the statechain does not delete previously held keyshares, then the current owner is not the unilateral owner of the funds, and the statechain entity and a previous owner can double spend them. This effectively means that users do not have provable assurances that they are the only party that can immediatetly spend the UTXO with the statechain entity.";
        readonly expandable: true;
    };
    readonly AltRollupAltTokenNoFraudProofsPlusUpgrade: {
        readonly type: "error";
        readonly title: "This token is not bridged to the network from bitcoin";
        readonly content: "The token is bridged to the network's from a bridge contract hosted on its parent chain. The bridge escrowing funds does not have a functioning proof system. The proposer can submit a malicious state transition and steal funds from the bridge. Additionally, the bridge contract can be upgraded by a centralized party or federation. A malicious upgrade could result in loss of user funds.";
        readonly expandable: true;
    };
    readonly AltRollupAltTokenNoFraudProofsPlusUpgradeDelayed: {
        readonly type: "error";
        readonly title: "This token is not bridged to the network from bitcoin";
        readonly content: "The token is bridged to the network's from a bridge contract hosted on its parent chain. The bridge escrowing funds does not have a functioning proof system. The proposer can submit a malicious state transition and steal funds from the bridge. Additionally, the bridge contract can be upgraded by a centralized party or federation. A malicious upgrade could result in loss of user funds. There is a delay to upgrades.";
        readonly expandable: true;
    };
    readonly WrapperCentralized: {
        readonly type: "error";
        readonly title: "Bitcoin backing this token is secured by a centralized party";
        readonly content: "The bitcoin backing this token is secured by a centralized party. This party can unilaterally spend the funds backing this wrapped asset. Malicious operators can result in loss of user funds.";
    };
    readonly AltRollupAltTokenProofsUpgrade: {
        readonly type: "error";
        readonly title: "This token is not bridged to the network from bitcoin";
        readonly content: "The token is bridged to the network's from a bridge contract hosted on its parent chain. Users must consider how the native bitcoin is secured. Additionally, while there is a proving system in place, the bridge contract can instantly upgraded by a centralized party or federation. In the event of a malicious upgrade, user funds could be stolen.";
        readonly expandable: true;
    };
    readonly AltRollupAltTokenUnderReview: {
        readonly type: "warning";
        readonly title: "This token is not bridged to the network from bitcoin";
        readonly content: "The token is bridged to the network's from a bridge contract hosted on its parent chain. The bridge does not have a functioning proof system. The proposer can submit a malicious state transition and steal funds from the bridge.";
    };
    readonly BitcoinBridgeNoSigners: {
        readonly type: "error";
        readonly title: "The signers for this bridge have not been disclosed";
        readonly content: "The signers for this bitcoin two-way peg have not been disclosed. The signers have unilateral control of funds backing this wrapped asset. Collusion can result in loss of user funds. There is no reputational damange for these signers if they act maliciously.";
        readonly expandable: true;
    };
...
declare enum Reviewsnippet {
    ...
    enzoBTC = "Funds backing enzoBTC are secured by various custodians including Cobo, Ceffu, and Chainup.",
    ...
    BotanixStakedBTC = "Botanix stBTC is a derivative asset backed by Botanix pBTC locked in a staking vault. The contract is upgradable [by a 3/5 multisig](https://botanixscan.io/address/0x09C5874F1425697C81c34F58957f2BE584306312).",
