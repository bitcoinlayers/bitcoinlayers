...
export declare enum Categorization {
...
export declare enum TokenSnippet {
...
export declare enum ReviewSnippet {
...
export declare enum WrapperReviews {
...
export declare enum WrapperSnippet {
    BlacklistYes = "The token implementation has a blacklist function."
}
export declare enum BTCWrapperTransparency {
...
export declare enum RiskSummarySnippet {
...
export declare enum PegRiskSummarySnippet {
...
export declare enum OtherRiskSummarySnippet {
...
export declare enum DefinitionSnippet {
