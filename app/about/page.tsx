                    ...
                    <div className="flex flex-col gap-12 w-full rounded-md">
                        <div className="flex flex-col gap-8 w-full">
                            <InfoBox
                                ...
                                The website is developed by LX Research Labs and is free and open-source under the MIT license. Anyone is welcome to use our research however they see fit, but we do request that you credit us when doing so. 
