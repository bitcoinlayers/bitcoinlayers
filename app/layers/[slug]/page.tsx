    ...
    return (
        <article className="flex flex-col lg:min-h-screen max-w-5xl mx-auto lg:pt-24 pt-12">
            ...
            <div className="lg:container mx-4 lg:px-4 flex lg:flex-row flex-col">
                <div className="lg:w-1/5 z-40 lg:sticky lg:top-[60px] h-fit max-h-[calc(100vh-60px)] w-full overflow-y-auto overflow-x-hidden lg:pt-6 lg:px-2 no-scrollbar py-0 bg-background">
