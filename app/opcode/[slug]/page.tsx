    ...
    <article className="flex flex-col min-h-screen max-w-5xl mx-auto pt-24">
      <div className="flex justify-start items-center gap-8 my-12">
        <div className="flex justify-center items-center">
          <OpcodeImage title={opcode.title} src={`/logos/${opcode.slug}.png`} /> {/**TODO fix img sizes. they're blurry here */}
        </div>
...
function OpcodeImage({ src, title }: { src: string; title: string }) { //TODO lazy loading
