...
export default function LayerTVLChart() {
    ...
    const finalChartData = useMemo(() => {
        if (layer?.limitedData && processedData.length > 0) {
    ...
    }, [layer?.limitedData, processedData, dateRange, tokens, filterDataByDateRange]);
                    ...
                    >
                        ...
                        <ChartTooltip
                            ...
                            content={({ active, payload, label }) => {
                                ...
                                if (layer?.limitedData && active && payload && payload.length > 0) {
