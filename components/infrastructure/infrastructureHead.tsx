...
const LinkButton = ({
  ...
  <a
    href={href}
    target="_blank"
    className="inline-block sm:m-1 sm:px-4 px-3 py-2 rounded transition duration-300 ease-in-out dark:bg-secondary no-underline font-header font-bold text-center"
  >
    {children}
  </a>
);
