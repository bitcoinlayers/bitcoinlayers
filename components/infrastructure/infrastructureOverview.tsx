...
const Description: React.FC<{ infrastructure: Infrastructure }> = ({ infrastructure }) => {
  return <div className="self-stretch text-text_secondary">{infrastructure.description}</div>;
};
...
const InfrastructureOverview: React.FC<{ infrastructure: Infrastructure }> = ({ infrastructure }) => {
  return (
