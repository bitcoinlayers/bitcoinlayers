...
const LinkButton = ({
  ...
  <a
    href={href}
    target="_blank"
    className="inline-block sm:m-1 sm:px-4 px-3 py-2 rounded transition duration-300 ease-in-out bg-lightsecondary no-underline font-header font-bold w-1/8 sm:w-1/6 text-center"
  >
    {children}
  </a>
);
...
const LayerHead: React.FC<{ layer: Layer }> = ({ layer }) => {
  return (
    <div className="flex flex-wrap justify-between" id="overview">
