        ...
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6">
                <p className="text-left max-w-prose text-gray-900 dark:text-gray-100">
                    This network is denominated in BTC. This means that users do not need to use an alternative token to interact with the network. Please review BTC custody scores to understand the trust assumptions related to the pegged asset used for fees.
                </p>
            </div>
