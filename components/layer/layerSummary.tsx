...
const LayerSummary: React.FC<{ layer: Layer }> = ({ layer }) => {
  return (
    <div className="flex flex-wrap sm:flex-row sm:flex-nowrap justify-between w-full sm:w-full panel p-4 rounded-xl sm:mr-4 mb-0 sm:mb-0 bg-lightsecondary dark:bg-secondary">
      <div className="w-full sm:w-1/4 mb-2 sm:mb-0 sm:mr-4 sm:ml-0 -ml-1 mr-1 sm:px-0 pl-4 sm:border-r border-b sm:border-b-0 border-copycolor">
        <div className="textbox flex flex-col justify-between items-baseline mx-auto">
          <h4 className="text-base font-medium my-0 sm:my-1">Bridge</h4>
          <h3 className="text-m font-bold my-2 h-6 sm:h-12">{layer.btcBridge}</h3>
          <div className="text-sm font-extralight my-0 sm:my-2 cursor-pointer relative group">
            ...
            <div className="absolute -left-4 sm:-left-20 top-full w-60 mt-2 hidden group-hover:flex flex-col items-center before:content-[''] before:absolute before:top-0 before:left-1/2 before:-translate-x-1/2 before:-translate-y-full before:border-l-8 before:border-l-transparent before:border-r-8 before:border-r-transparent before:border-b-8 before:border-b-white z-10">
              <div className="bg-lightsecondary dark:bg-secondary dark:text-white text-xs rounded py-1 px-3 border border-white">
      ...
      <div className="w-full sm:w-1/4 mb-2 sm:mb-0 sm:mr-4 sm:ml-0 -ml-1 mr-1 sm:px-0 pl-4 sm:border-r border-b sm:border-b-0 border-copycolor">
        <div className="textbox flex flex-col justify-between items-baseline mx-auto">
          <h4 className="sm:text-base font-medium my-0 sm:my-1">BTC TVL</h4>
          <h3 className="sm:text-m font-bold my-2 h-6 sm:h-12">{Number(layer.btcLocked).toLocaleString()} BTC</h3>
          <div className="text-sm font-extralight my-0 sm:my-2 cursor-pointer relative group">
            Learn More
            <div className="absolute sm:-left-20 top-full w-60 mt-2 hidden group-hover:flex flex-col items-center before:content-[''] before:absolute before:top-0 before:left-1/2 before:-translate-x-1/2 before:-translate-y-full before:border-l-8 before:border-l-transparent before:border-r-8 before:border-r-transparent before:border-b-8 before:border-b-white z-10">
              <div className="bg-lightsecondary dark:bg-secondary dark:text-white text-xs rounded py-1 px-2 border border-white">
      ...
      <div className="w-full sm:w-1/4 mb-2 sm:mb-0 sm:mr-4 sm:ml-0 -ml-1 mr-1 sm:px-0 pl-4 sm:border-r border-b sm:border-b-0 border-copycolor">
        <div className="textbox flex flex-col justify-between items-baseline mx-auto">
          <h4 className="text-base font-medium my-0 sm:my-1">Layer</h4>
          <h3 className="text-m font-bold my-2 h-6 sm:h-12">{layer.layerType}</h3>
          <div className="text-sm font-extralight my-0 sm:my-2 cursor-pointer relative group">
            Learn More
            <div className="absolute -left-4 sm:-left-20 top-full w-60 mt-2 hidden group-hover:flex flex-col items-center before:content-[''] before:absolute before:top-0 before:left-1/2 before:-translate-x-1/2 before:-translate-y-full before:border-l-8 before:border-l-transparent before:border-r-8 before:border-r-transparent before:border-b-8 before:border-b-white z-10">
              <div className="bg-lightsecondary dark:bg-secondary dark:text-white text-xs rounded py-1 px-2 border border-white">
      ...
      <div className="w-full sm:w-1/4 mb-0 sm:px-0 pl-4">
        <div className="textbox flex flex-col justify-between items-baseline mx-auto">
          <h4 className="text-base font-medium my-0 sm:my-1">Fee Token</h4>
          <h3 className="text-m font-bold my-2 h-6 sm:h-12">{layer.feeToken}</h3>
          <div className="text-sm font-extralight my-0 sm:my-2 cursor-pointer relative group">
            Learn More
