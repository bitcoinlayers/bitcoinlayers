    ...
    return (
        ...
        >
            <div className="w-44 p-4 justify-start items-center gap-4 inline-flex">
                <div
                    className={`w-6 h-6 p-[4px] ${getRiskColorClass(riskLevels[0]?.tier).bg} rounded-full justify-center items-center flex`}
                >
                    <svg
                        viewBox="0 0 24 24"
                        className="w-3.5 h-3.5 relative"
                        style={{
                            fill: getRiskColorClass(riskLevels[0]?.tier).fill,
                        }}
                    >
                        <g id="Group">
                            <g id="Group_2">
                ...
                <div
                    className={`w-6 h-6 p-1 ${getRiskColorClass(riskLevels[1]?.tier).bg} rounded-full justify-center items-center flex`}
                >
                    <svg
                        viewBox="0 0 24 24"
                        className="w-4 h-4 relative flex-col justify-start items-start flex"
                        style={{
                            fill: getRiskColorClass(riskLevels[1]?.tier).fill,
                        }}
                    >
                        <g
                ...
                <div
                    className={`w-6 h-6 px-1.5 py-[5px] ${getRiskColorClass(riskLevels[2]?.tier).bg} rounded-full justify-center items-center flex`}
                >
                    <svg
                        viewBox="0 0 24 24"
                        className="w-4 h-4 relative flex-col justify-start items-start flex"
                        style={{
                            fill: getRiskColorClass(riskLevels[2]?.tier).fill,
                        }}
                    >
                        <path
                            id="Vector"
                ...
                <div
                    className={`w-6 h-6 p-[5.50px] ${getRiskColorClass(riskLevels[3]?.tier).bg} rounded-full justify-center items-center flex`}
                >
                    <svg
                        viewBox="0 0 24 24"
                        className="w-[13px] h-[13px] relative"
                        style={{
                            fill: getRiskColorClass(riskLevels[3]?.tier).fill,
                        }}
                    >
                        <g id="Group">
                            <path
                    ...
                    {layer.riskAnalysis
                        ...
                        .map((content, contentIndex) => (
                            <div key={contentIndex} className="mb-2">
                                ...
                                <div className="mb-4">{content.title}</div>
                            </div>
                        ))}
                </div>
            )}
