...
export default function OtherReasonBridgeDialogBody({
    layer,
    title = "Why is this project here?",
}: {
    layer: LayerProject;
    title?: string;
}) {
        ...
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6">
                <p className="text-left max-w-prose text-gray-900 dark:text-gray-100">
                    The project claims to be a bitcoin layer, but does not have an enshrined bitcoin bridge that meets our sidesystem standards.
                </p>
            </div>
            <div className="my-4"></div>
            <div className="grid grid-cols-1 gap-4 sm:gap-6">
                <p className="text-left max-w-prose text-gray-900 dark:text-gray-100">
                    To be considered a sidesystem, the project must have an enshrined bitcoin bridge with 5 external signers that are publicly known.
                </p>
            </div>
            <DialogFooter className="mt-4 sm:mb-t pt-4 pb-2 border-t flex-row justify-center sm:justify-center">
                ...
                >
                    Learn more about our sidesystem standards
                </a>
            </DialogFooter>
        </div>
    );
