        ...
        <thead className="bg-table_header">
            <tr className="border-b border-stroke_tertiary">
                {headers.map((header, index) => (
                    <th
                        key={index}
                        className={`lg:px-6 px-4 lg:py-6 py-2 font-medium text-text_table_header table_header border-t border-stroke_tertiary ${
                            index === 0
                                ? "border-l first:rounded-tl-xl first:border-r lg:border-r-0 lg:first:border-r-0 border-stroke_tertiary"
                                : ""
                        } ${
                            index === headers.length - 1
                                ? "border-r first:rounded-tr-xl"
                                : ""
                        }`}
                    >
                                ...
                                {header.filterOptions && (
                                    <div className="relative mr-2">
                                        <Image
                                            ...
                                            onClick={() =>
                                                toggleFilterDropdown(header.name)
                                            }
                                        />
