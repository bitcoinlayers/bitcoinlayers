              ...
              <div className="absolute top-full lg:left-0 right-0 mt-2 w-[282px] bg-white rounded-xl shadow flex-col justify-start items-start gap-2 inline-flex z-50 p-4">
                ...
                <div className="h-[88px] p-3 rounded-md flex-col justify-start items-start flex hover:bg-blue-100">
                  <Link href="/bridge" onClick={closeSubmenu}>
                    ...
                    <div className="self-stretch text-slate-500 text-sm font-normal leading-tight">
                      Overview and risk analysis of bitcoin bridges between
                      layers.
                    </div>
                  </Link>
                </div>
                ...
                <div className="h-[88px] p-3 rounded-md flex-col justify-start items-start flex hover:bg-blue-100">
                  <Link href="/opcode" onClick={closeSubmenu}>
                    ...
                    <div className="self-stretch text-slate-500 text-sm font-normal leading-tight">
                      List and summary of active and proposed opcodes.
                    </div>
                  </Link>
                </div>
                <div className="h-[88px] p-3 rounded-md flex-col justify-start items-start flex hover:bg-blue-100">
                  <Link href="/upcominglayers" onClick={closeSubmenu}>
                    ...
                    <div className="self-stretch text-slate-500 text-sm font-normal leading-tight">
                      List and summary of production, testnet, and announced
                      bitcoin layers.
                    </div>
                  </Link>
                </div>
    ...
    return (
      <div className="pt-8 px-4">
        <ul className="flex flex-col gap-y-6">
          <li className="">
            <Link href="/glossary" className="text-black" onClick={closeSheet}>
              Glossary
            </Link>
          </li>
          <li className="">
            <Link href="/faq" className="text-black" onClick={closeSheet}>
              FAQ
            </Link>
          </li>
          <li className="">
