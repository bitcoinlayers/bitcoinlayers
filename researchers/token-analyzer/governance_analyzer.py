...
class GovernanceAnalyzer:
    ...
    def generate_markdown_report(self, address: str, analysis_data: dict):
        ...
        markdown_content = f"""# Governance Analysis Report
...
"""
        ...
        # Save to file
        filename = os.path.join(output_dir, f"governance_{address.lower()}.md")
        with open(filename, 'w') as f:
            f.write(markdown_content)
        
        print(f"✅ Governance analysis report saved to: {filename}")
    ...
    def generate_json_report(self, bridge_address: str, token_address: str, analysis_data: dict):
        ...
        bridge_name = f"Associated Bridge ({NETWORK.title()})"
        ...
        print(f"   → Added bridge analysis for {bridge_address}")
